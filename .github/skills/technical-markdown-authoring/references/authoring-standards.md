...
- One paragraph that states the problem, the audience, and the payoff.
...
- Commands, snippets, or examples
- Risks, tradeoffs, or gotchas
- Links and follow-up actions
...
- Questions to raise live
- Reference links

## Writing rules

- Prefer strong nouns and verbs over hype language.
- Use lists for operational detail, not for every paragraph.
- Keep headings specific enough that they still make sense out of context.
...
- Call out where live demos can fail and what the fallback narrative is.
