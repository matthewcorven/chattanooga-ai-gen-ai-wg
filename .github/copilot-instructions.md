...
- Treat this repository as a Markdown-first publishing workspace for meetup decks, diagram assets, and published HTML/PDF outputs.
...
- Build outputs should preserve the lead-slide QR block that points to the published HTML and PDF artifacts.
